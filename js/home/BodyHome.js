      ...
      <h2>Transactions (${completedProjects})</h2>
        ...
        <div class="project-body">
          ${datatransaction.data.transaction.map((t)=>{
              ...
              const xp = convertXPToReadable(t.amount);
              ...
              <div class="project-row">
                ...
                <div class="col members">
                  ${members
                    .map(
                      (m) =>
                        `<div class="userLogin"><a href="https://profile.zone01oujda.ma/profile/${m.userLogin}" target="_blank">${m.userLogin}</a></div>`
                    )
                    .join(" ")}
                </div>
