...
export function Header() {
    ...
    nav.innerHTML =/*html*/`
        ...
        <div class="info-header">
            <svg xmlns="https://www.svgrepo.com/show/486506/user-profile-filled.svg" version="1.1" viewBox="-5.0 -10.0 110.0 135.0" class="profile-icon">
...
async function ProfileSection() {
    ...
    // const cohort = data.data.user[0].events[0].cohorts[0].labelName || "cohort not found";
    ...
    userInfoSec.innerHTML =/*html*/`
            ...
            <img src=${useravatar ? useravatar:""} alt="profile pic" class="profile-pic"/>
            </div>
            <div class="username">
            ...
            <div class="info-data">
                ...
                <p><span>Address:</span> ${info.addressStreet || "--"}</p>
            </div>
        `
